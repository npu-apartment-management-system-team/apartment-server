...
public enum ApplicationStatusEnum {
    ...
    // 房建段班组长等待入住确认
    @JsonProperty("CENTER_DORM_MANAGER_CHECK_IN_CONFIRM")
    CENTER_DORM_MANAGER_CHECK_IN_CONFIRM(1_6),

    // 入住申请被本单位驳回
    @JsonProperty("DEPARTMENT_CHECK_IN_REJECT")
    DEPARTMENT_CHECK_IN_REJECT(1_7),

    // 入住申请被房建段驳回
    @JsonProperty("CENTER_CHECK_IN_REJECT")
    CENTER_CHECK_IN_REJECT(1_8),

    // 缴纳押金超时
    @JsonProperty("CHECK_IN_DEPOSIT_TIMEOUT")
    CHECK_IN_DEPOSIT_TIMEOUT(1_9),

    // 班组长确认超时
    @JsonProperty("CENTER_DORM_MANAGER_CHECK_IN_CONFIRM_TIMEOUT")
    CENTER_DORM_MANAGER_CHECK_IN_CONFIRM_TIMEOUT(1_10),

    // 用户撤回入住申请
    @JsonProperty("CHECK_IN_WITHDRAW")
    CHECK_IN_WITHDRAW(1_11),
    ...
    // 新宿管确认入住
    @JsonProperty("CENTER_DORM_MANAGER_CHECK_IN_CONFIRM")
    CENTER_DORM_MANAGER_CHANGE_CHECK_IN_CONFIRM(2_6),

    // 调宿申请被本单位驳回
    @JsonProperty("DEPARTMENT_CHANGE_DORM_REJECT")
    DEPARTMENT_CHANGE_DORM_REJECT(2_7),

    // 调宿申请被房建段驳回
    @JsonProperty("CENTER_CHANGE_DORM_REJECT")
    CENTER_CHANGE_DORM_REJECT(2_8),

    // 原有宿管确认离宿超时
    @JsonProperty("CENTER_DORM_MANAGER_CHECK_OUT_CONFIRM_TIMEOUT")
    CENTER_DORM_MANAGER_CHANGE_CHECK_OUT_CONFIRM_TIMEOUT(2_9),

    // 新宿管确认入住超时
    @JsonProperty("CENTER_DORM_MANAGER_CHECK_IN_CONFIRM_TIMEOUT")
    CENTER_DORM_MANAGER_CHANGE_CHECK_IN_CONFIRM_TIMEOUT(2_10),

    // 用户撤回调宿申请
    @JsonProperty("CHANGE_DORM_WITHDRAW")
    CHANGE_DORM_WITHDRAW(2_11),
    ...
    // 宿管确认退宿
    @JsonProperty("CENTER_DORM_MANAGER_CHECK_OUT_CONFIRM")
    CENTER_DORM_MANAGER_CHECK_OUT_CONFIRM(3_2),
